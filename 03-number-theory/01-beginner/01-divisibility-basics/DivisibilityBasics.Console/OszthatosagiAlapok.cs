...
public static class OszthatosagiAlapok
{
    ...
    public static bool OsztoE(int oszto, int szam) => false;
    ...
    public static bool ParosE(int szam) => false;
    ...
    public static bool ParatlanE(int szam) => false;
    ...
    public static bool KozosOsztoE(int a, int b, int oszto) => false;
}
